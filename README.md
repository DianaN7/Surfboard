<h2>💫 Адаптированный под все устройства вебсайт Surfboard, написанный для магазинов по продаже спортивного инвертаря для активного отдыха на воде. В итоговом варианте кода было реализовано:</h2>
