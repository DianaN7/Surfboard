;(function() {
  ...
  $('.team__title').on('click', e =>{
    ...
    if(elemStore.hasClass('active')){
      closeItem(itemStore);
      triangle.attr('xlink:href', '.new/src/img/sprite.svg#down')
    } else{
      closeItem(itemStore);
      openItem(chosenElem);
      triangleAll.attr('xlink:href', '.new/src/img/sprite.svg#down');
      triangle.attr('xlink:href', '.new/src/img/sprite.svg#up');
